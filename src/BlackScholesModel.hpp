...
class BlackScholesModel{
    ...
    public:
        ...
        void shift_asset(double t, PnlMat* path1, PnlMat* path2,double fdstep, int asset_i);
        void unshift_asset(double t, PnlMat* path1, PnlMat* path2,double fdstep, int asset_i);
